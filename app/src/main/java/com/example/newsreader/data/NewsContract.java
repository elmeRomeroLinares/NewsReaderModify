...
public class NewsContract {
    ...
    // Content authority
    static final String CONTENT_AUTHORITY = "com.example.newsreader";

    // Base content URI
    private static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    // PATH_TableName
    static final String PATH_NEWS_TABLE = "savedArticles";
    ...
    public static final class NewsEntry implements BaseColumns {
        ...
        static final String TABLE_NAME = "savedArticles";
